...
/*   Updated: 2025/01/02 09:49:12 by marigome         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*ft_check_death(void *arg)
{
	...
	while (1)
	{
		...
		{
			ft_print_message(DEAD, philo, philo->data);
...
void	ft_take_fork(t_philo *philo)
{
	...
	ft_print_message(TAKEN_FORK, philo, philo->data);
	usleep(100);
	sem_wait(philo->data->forks);
	ft_print_message(TAKEN_FORK, philo, philo->data);
}
...
{
	ft_take_fork(philo);
	ft_print_message(EAT, philo, philo->data);
	sem_wait(philo->data->death);
...
{
	ft_print_message(SLEEP, philo, philo->data);
