...
/*   Updated: 2025/01/02 09:48:14 by marigome         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_data
{
	...
	sem_t			*stop;			// Mutex to control the stop
...
void			ft_print_message(char *id, t_philo *philo, t_data *data);
char			*ft_itoa(int n);
void			ft_checker_status(char *id, char *timestatus, t_philo *philo);
